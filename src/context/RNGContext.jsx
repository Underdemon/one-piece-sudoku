                    ...
                    while (!valid) {
                        ...
                        for (let j = 0; j < size; j++) {
                            ...
                            if (
                                ...
                                colValues.intersection(rowValues).size < 4 // the intersection size is the number of characters that fit any combination (so the number of possible characters that are valid)
                            ) {
